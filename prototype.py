...
if __name__ == '__main__':
        banana = Prototype( w_bt= 3.4316619745454546, w_baf= 0.7726841811731093, w_cr= 0.45, w_ci= 0.9340945454545454, w_ct= 0.8, w_z= 0.18, w_inc= -0.16205178924663055, w_wo= -0.6228282610145456, w_d= 2.1910509394806295, eh_b= 0.8, eh_cr= 0.23687352087946484, eh_ct= 0.8607412277071075, eh_inc= -0.21000042855377632, ev_b= 0.4, ev_ct= 0.9, eh_x= 1.2476108865296893, eh_z= 0.43612911823269146, motor_x= -0.4,)
